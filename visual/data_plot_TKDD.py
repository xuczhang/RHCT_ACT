...
class DataPlot:
    ...
    def draw_act(self, act_file):
        import csv
        with open(act_file, 'rb') as f:
            reader = csv.reader(f)
            act_list = list(reader)
        x = [i for i in range(1, len(act_list) + 1)]
        # plt.xticks(x, xticks)
        ...
        plt.plot(x, act_list, linestyle='--', marker='o', markersize=5, linewidth=2, color='#5461AA',
    ...
    def draw_beta_recovery(self, result_dir, k, p, bNoise, fn):
        ...
        Y_RACT = mat_contents["RACT_result"][0].tolist()
        ...
        plt.plot(x, Y_RLHH, linestyle='--', marker='>', markersize=5, linewidth=3, color='#1049A3', label='RHCT')
        plt.plot(x, Y_RACT, linestyle='-.', marker='o', markersize=5, linewidth=3, color='red', label='RACT')
        ...
        #plt.savefig(pp, format='pdf')
        #plt.close()
        # dir = 'D:/Dropbox/PHD/publications/IJCAI2017_RLHH/paper/images/'
        # plt.savefig(dir + fn, format='png', dpi=400)

    def draw_runtime_cr(self, result_dir, k, p, bNoise, fn):
        ...
        #pp = PdfPages("D:/Dropbox/PHD/publications/IJCAI2017_RLHH/paper/images/runtime_1.pdf")
        #pp = PdfPages("D:/runtime_1.pdf")
        #plt.savefig(pp, format='pdf')
        dir = 'D:/Dropbox/PHD/publications/IJCAI2017_RLHH/paper/images/'
        plt.savefig(dir + fn, format='png', dpi=400)


    def draw_runtime_datasize(self, result_dir, cr, p, bNoise, fn):
    ...
    def exp_beta_recovery(self):
        ...
        result_dir = 'D:/Dropbox/PHD/publications/Journal_TKDD_RLHH/experiment/'
        ...
        bNoise = 1
        fn = 'beta_1.png'
        data_plot.draw_beta_recovery(result_dir, k, p, bNoise, fn)
    ...
    def exp_runtime(self):
        ...
        bNoise = 0
        fn = 'runtime_1.png'
        data_plot.draw_runtime_cr(result_dir, k, p, bNoise, fn)
        ...
        cr = 0.1
        fn = 'runtime_2.png'
        #data_plot.draw_runtime_datasize(result_dir, cr, p, bNoise, fn)

if __name__ == '__main__':

    data_plot = DataPlot()

    act_file = "D:\\Dropbox\\PHD\\publications\\Journal_TKDD_RLHH\\images\\act.csv"
    data_plot.draw_act(act_file)
